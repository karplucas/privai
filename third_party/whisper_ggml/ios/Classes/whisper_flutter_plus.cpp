...
{
    fprintf(stderr, "PRIVAI_WHISPER phase=request_parsed_start\n");
    fflush(stderr);
    ...
    fprintf(stderr, "PRIVAI_WHISPER phase=model_loaded\n");
    fflush(stderr);
    ...
    fprintf(stderr, "PRIVAI_WHISPER phase=wav_decoded samples=%zu\n", pcmf32.size());
    fflush(stderr);
    ...
    // run the inference
    {
        ...
        fprintf(stderr, "PRIVAI_WHISPER phase=inference_start threads=%d\n", params.n_threads);
        fflush(stderr);
        ...
        fprintf(stderr, "PRIVAI_WHISPER phase=inference_complete\n");
        fflush(stderr);
